          ...
          <Benefits heading="Explore Your Achievements">
            ...
            <BenefitSimple
             ...
             `}
              subheading={
                userData.score
                  ? `Status rank: ${getRank(userData.score)}`
                  : "Status rank: Not Ranked"
              }
              text={
                userData.score
                  ? `Congratulations! With a global score of ${
                      userData.score
                  ...
                  : "Your global score is not available yet. Keep participating in quizzes to get ranked!"
              }
              iconPath={
